...
with models.DAG(
        "dataset-ingest-to-GCS-dag_asynch_modified",
    ...
    t0_task_conditional_check = DummyOperator(
...
#     )
    ...
    trigger_insert_count_dag = TriggerDagRunOperator(
    task_id='trigger_insert_count_dag',
    trigger_dag_id='insert_source_table_count_dag',
...
start_pipeline >> trigger_insert_count_dag >> t0_task_conditional_check
...
t1_dataflow_job_file_to_bq_product >> t2_insert_product_table
t1_dataflow_job_file_to_bq_customer >> t2_insert_customer_table
t1_dataflow_job_file_to_bq_employee >> t2_insert_employee_table
t1_dataflow_job_file_to_bq_sales >> t2_insert_sales_table
t1_dataflow_job_file_to_bq_gender >> t2_insert_gender_table
